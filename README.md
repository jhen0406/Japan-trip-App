...
## 🎨 專屬主題色彩
本專案採用您指定的色系進行全局設計：
- **主要色 (Primary)**: `#1A3263` (海軍藍)
- **次要色 (Secondary)**: `#547792` (鋼針藍)
- **點綴色 (Accent)**: `#FAB95B` (溫暖橙黃)
- **背景與底色 (Beige)**: `#E8E2D9` (米色系)
...
### 工作表一：行程表
請將第一頁下方的工作表標籤命名為 **`行程表`**，並在第一列 (A1~H1) 填寫以下標題：
| 日期 | 行程天數 | 時間 | 地點 | 備註 | 地圖搜尋字詞 | 交通工具 | 交通時間 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 11/20 | D1 | 10:00 | 福岡機場抵達 | 領行李與買網卡 | 福岡機場國際線 | | |
| 11/20 | D1 | 12:00 | 博多車站午餐 | 吃拉麵 | 博多車站 | 地下鐵綠線 | 15分 |
| 11/20 | D1 | 13:30 | 搭乘由布院之森 | 使用JR Pass | | JR特急 | 2.5小時 |

### 工作表二：記帳
請新增第二頁工作表，命名為 **`記帳`**，並在第一列 (A1~I1) 填寫以下標題：
| ID | 時間 | 金額 | 幣別 | 類別 | 購買項目 | 付款人 | 付款方式 | 備註與地點 | 圖片連結 | 免稅 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
| TX003 | 2026/03/15 19:10:00 | 1500 | TWD | 交通 | 網路 eSIM | 旅伴 | 電子支付(LinePay) | Klook | | FALSE |
